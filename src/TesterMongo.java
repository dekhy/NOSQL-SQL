...
public class TesterMongo {
	...
	//  chama o outro lado pra contar
		...
		try {
			...
			BufferedReader reader = new BufferedReader(new FileReader("8.txt")); // ler arquivo
			...
			while (linha != null) {
				...
				// inserir
				DBObject document = new BasicDBObject("Dados",
				                new BasicDBObject("Data", ""+dados[1])
				                        .append("Latitude", ""+dados[2])
				                        .append("Longitude", ""+dados[3]));
