...
public class TesterMysql {
   ...
   public static void main(String args[]) {
      ...
      try {   
         ...
         BufferedReader reader = new BufferedReader(new FileReader("arquivo/10000.txt"));   
...
*/
         ...
         while (linha != null) {
            ...
            stm.executeUpdate("insert into dados (dati,longitude,latitude) values ('"+dados[1]+"','"+dados[2]+"','"+dados[3]+"'	);");   
